...
document.getElementById("siBtn").addEventListener("click", function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡sabia que dirias que si, ahora abre el sobre';

    // Mostrar otro gif después de 1 segundo
    setTimeout(function() {
    ...
    setTimeout(function() {
        window.location.href = "carta.html"; // Cambia esto por la URL a la que quieres redirigir
    }, 4000);
});
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Tienes a otro?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
